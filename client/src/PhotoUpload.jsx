...
const PhotoUpload = ({ addedPhotos, onChange }) => {
  ...
  async function addPhotoByLink(e) {
    e.preventDefault();
    const { data: filename } = await axios.post("http://15.164.233.61:4000/upload-by-link", {
      link: photoLink,
    });
    onChange((prev) => {
          ...
          addedPhotos.map((link) => (
            <div className="h-60 flex relative">
              ...
              <button
                ...
                className=" cursor-pointer absolute bottom-1 right-1 text-white bg-black p-1 rounded-xl bg-opacity-50 py-2 px-3"
              >
                <svg
              ...
              <button
                ...
                className=" cursor-pointer absolute bottom-1 left-1 text-white bg-black p-1 rounded-xl bg-opacity-50 py-2 px-3"
              >
                {link === addedPhotos[0] && (
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
